...
namespace PS6000Imports
{
	class Imports
	{
        ...
        //public const int MaxVolt = 4000;

        public const double MaxVolt = 0.465;
        ...
        public enum PS6000_ETS_MODE : int
        {
            PS6000_ETS_OFF,
            PS6000_ETS_FAST,
            PS6000_ETS_SLOW
        ...
        public delegate void ps6000BlockReady2(short handle, uint status, IntPtr pVoid);
        ...
        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps6000RunBlock")]
        public static extern UInt32 RunBlock2(
                                                short handle,
                                                uint noOfPreTriggerSamples,
                                                uint noOfPostTriggerSamples,
                                                uint timebase,
                                                ...
                                                out int timeIndisposedMs,
                                                uint segmentIndex,
                                                ps6000BlockReady2 lpps6000BlockReady,
                                                IntPtr pVoid);
        ...
        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps6000GetTimebase2")]
        public static extern UInt32 GetTimebase2(
                                                    short handle,
													uint timebase,
													uint noSamples,
        ...
        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps6000GetChannelRange")]
        public static extern uint GetChannelRange(
													short handle, 
													Channel channel, 
													out short range
													);

        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps6000GetAdcValue")]
        public static extern uint GetAdcValue(
                                                    short handle,
                                                    Channel channel,
                                                    short adcValueA
                                                    );

        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps6000SetEts")]
        public static extern UInt32 SetEts(
                                                    short handle,
													PS6000_ETS_MODE mode,
                                                    short etsCycles,
                                                    short etsInterleave,
													ref int sampleTimePicoseconds
                                                    );

        internal static uint RunBlock(short handle, uint noOfPreTriggerSamples, uint noOfPostTriggerSamples, uint timebase, short oversample, out int timeIndisposedMs, uint segmentIndex, ps6000BlockReady2 callbackDelegate2, IntPtr zero)
        {
